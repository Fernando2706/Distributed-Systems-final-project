...
public class Node2B {
	...
	public static void main(String[] args) {
		try {
			ServerSocket listenSocket = new ServerSocket(GlobalFunctions.getPort("NODEB2"));
			
			while(true) {
				System.out.println("Waiting node 2B...");
				Socket s = listenSocket.accept();
				new ConnectionNodeB2(2, GlobalFunctions.getExternalVariables("MAXNODES"), s,args);
			}
		} catch (Exception e) {
...
class ConnectionNodeB2 extends Thread{
	...
	public ConnectionNodeB2(int index, int maxNodes, Socket socket,String[] args) {
		try {
	...
	public void doConnect() {
		try {
			if(this.socketRight == null) {
				if(this.index == this.maxNodes) {
					System.out.println(GlobalFunctions.getIP("SPECIALNODEB"));
