...
public class NodeC1 {
	...
	public static void main(String[] args) {
		try {
			ServerSocket listenSocket = new ServerSocket(GlobalFunctions.getPort("NODEC1"));
			
			while(true) {
				System.out.println("Waiting node 1C...");
				Socket s = listenSocket.accept();
				new ConnectionNodeC(1, GlobalFunctions.getExternalVariables("MAXNODES"), s,args);
			}
		} catch (Exception e) {
...
class ConnectionNodeC extends Thread{
	...
	public ConnectionNodeC(int index, int maxNodes, Socket socket,String[] args) {
		try {
